...
<body>
   ...
   // define variables and set to empty values
	$food_nameErr  = $category_idErr = $sub_category_idErr = $cuisine_idErr = $restaurant_id = $descriptionErr = $priceErr = $availableErr = "";
...
//---------database insert
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
		...
		07. price: <input type="number" name="price" value="<?php echo $price;?>">
		<span class="error">* <?php echo $priceErr;?></span>
		<br><br>

		08. is food available?: 
		<br>
		<input type="radio" id="yes" name="available" value="yes">
